...
def get_recommendations(product_name, cosine_sim=cosine_sim):
    ...
    excluding all occurrences of the current product.
    ...
    Returns:
    list: Top recommendations with similarity scores.
    """
    ...
    for idx in product_indices:
        ...
        # Append recommendations for the current product with similarity scores
        recommendations.extend([(df['Product_name'].iloc[i], score) for i, score in sim_scores if i in top_indices])
