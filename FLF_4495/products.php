  ...
  <div class="row">
	...
	<div class="col-12 col-lg-6">
	  <ul class="list-unstyled">
		...
		<li class="dropdown-item"><a onclick="js1();" href="clients.php"  class="dropdown-link">Clients</a></li>
  ...
  <div class="row">
	...
	<div class="col-12 col-lg-6">
	  <ul class="list-unstyled">
		...
		<li class="dropdown-item"><a href="#" class="dropdown-link">Analyze products</a></li>
...
<div class="container mt-5 mb-5"> 
	...
	<div class="row text-center-xs d-middle">
				...
				<h1 class="display-5 fw-bold mb-0">
					<span class="text-success">Product </span> recommendation
				</h1>
				
				<p class="h3 fw-medium text-danger">
	...
	<input type="text" class="form-control form-control-sm iqs-input" data-container=".iqs-container" value="" placeholder="Search Product">
	<span class="fi fi-search btn btn-sm px-3 text-gray-500"></span>
</div>

<div class="iqs-container mt-3 scrollable-horizontal scrollable-styled-light" style="max-height: 300px;">

<?php
$sql = "SELECT Distinct product.id as id, product.name as name, category.name as cat, product.image_path as img
...
and comment like 'SubClie%'
and product.image_path NOT LIKE 'https%'
order by id desc";
...
?>
	...
	<div class="form-check iqs-item">
		<input class="form-check-input" type="checkbox" id="brand<?php echo $i; ?>" name="brand[]" value="<?php echo $row_products['name'];?>">
		<label class="form-check-label px-1" for="brand-1">
		<img class="border border-light p-1" width="50" src="https://app.freshlifefloral.com/<?php echo $row_products['img']; ?>" alt="...">
		<?php 
		echo $row_products['id']." / ".$row_products['name']." - ".$row_products['cat'];
		?>
		</label>
	</div>
<?php
